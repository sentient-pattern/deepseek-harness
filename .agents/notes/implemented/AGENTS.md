...
When a shipped note is unlikely to guide future work, archive its complete triplet through [`fw-archive-agent-notes`](../../skills/fw-archive-agent-notes/SKILL.md) instead of continuing to maintain it.
