...
- Read [docs/AGENTS.md](../../../docs/AGENTS.md) and use [fw-doc-standards](../fw-doc-standards/SKILL.md) when deciding where content belongs or changing product documentation prose.
...
Use [fw-pre-push-checks](../fw-pre-push-checks/SKILL.md) before pushing. Report the canonical files changed, manifest entries added or removed, public routes affected, and the exact checks run.
