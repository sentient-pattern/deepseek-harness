...
6. If removing prose changes a promised behavior rather than its explanation, use a proposed Agent Note first (follow [fw-find-simplifications](../fw-find-simplifications/SKILL.md)).
