...
| --- | --- | --- | --- |
| `@forgeweaver/cosmokit` | `cosmokit` | [github.com/forgeweaver-harness/cosmokit](https://github.com/forgeweaver-harness/cosmokit) | MIT |
| `@forgeweaver/schemastery` | `schemastery` | [github.com/forgeweaver-harness/schemastery](https://github.com/forgeweaver-harness/schemastery) | MIT |
| `@forgeweaver/cordis` | `cordis` | [github.com/cordiverse/cordis](https://github.com/cordiverse/cordis) | MIT |
| `@forgeweaver/cordis-plugin-loader` | `@cordisjs/plugin-loader` | [github.com/cordiverse/cordis](https://github.com/cordiverse/cordis) | MIT |
| `@forgeweaver/cordis-plugin-include` | `@cordisjs/plugin-include` | [github.com/forgeweaver-harness/cordis](https://github.com/forgeweaver-harness/cordis) | MIT |
| `@forgeweaver/cordis-plugin-group` | `@cordisjs/plugin-group` | [github.com/forgeweaver-harness/cordis](https://github.com/forgeweaver-harness/cordis) | MIT |
| `@forgeweaver/cordis-plugin-timer` | `@cordisjs/plugin-timer` | [github.com/forgeweaver-harness/cordis](https://github.com/forgeweaver-harness/cordis) | MIT |
| `@forgeweaver/cordis-plugin-hmr` | `@cordisjs/plugin-hmr` | [github.com/forgeweaver-harness/cordis](https://github.com/forgeweaver-harness/cordis) | MIT |
| `@forgeweaver/cordis-plugin-logger-console` | `@cordisjs/plugin-logger-console` | [github.com/forgeweaver-harness/cordis](https://github.com/forgeweaver-harness/cordis) | MIT |
...
`eslint-plugin-sonarjs` (LGPL-3.0-only) and `lightningcss` (MPL-2.0) run only as development tooling; their code is not linked into or distributed with any ForgeWeaver artifact.
...
| [`pydantic`](https://github.com/pydantic/pydantic) | MIT | runtime dependency of `forgeweaver-harness-sdk` |
