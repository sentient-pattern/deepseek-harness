...
it('boots the built plugin graph and renders a fixture session end to end', async () => {
  ...
  for (const plugin of ['@forgeweaver/fw-client-ui-layout', '@forgeweaver/fw-client-ui-sidebar', '@forgeweaver/fw-client-ui-conversation', '@forgeweaver/fw-client-ui-tool']) {
