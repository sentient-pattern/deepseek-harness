...
import type {} from '@forgeweaver/fw-goal'
import {
...
const PACKAGE_FILES: Readonly<Record<string, string>> = {
  ...
  'packages/client/ui-conversation/package.json': '{"name":"@forgeweaver/fw-client-ui-conversation"}\n',
  ...
  'packages/context/session-reference/package.json': '{"name":"@forgeweaver/fw-session-reference"}\n',
  ...
  'packages/llm/token-meter/package.json': '{"name":"@forgeweaver/fw-token-meter"}\n',
  ...
  'packages/skill/skill-filesystem/package.json': '{"name":"@forgeweaver/fw-skill-filesystem"}\n',
