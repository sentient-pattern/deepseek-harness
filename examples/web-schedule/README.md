...
This overlay opts one `fw web` process into Schedule reminders without changing the shipped default Web composition:

```sh
fw web --patch examples/web-schedule/cordis.yml
```
