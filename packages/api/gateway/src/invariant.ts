/**
 * Package-owned invariant companion for `@forgeweaver/fw-api-gateway`.
 * @module @forgeweaver/fw-api-gateway/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-api-gateway'
