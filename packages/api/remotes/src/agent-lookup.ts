...
import type { Agent, AgentOptions, AgentSetup } from '@forgeweaver/fw-agent'
...
import type {} from '@forgeweaver/fw-typert-registry'
...
export async function inspectApiRemoteSession(
  ...
  if (persistence === undefined) {
    throw new Error('session persistence is not configured (load a fw-session-persistence backend)')
  }
