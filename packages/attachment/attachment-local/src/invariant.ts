/** Package-owned invariant companion for `@forgeweaver/fw-attachment-local`. @module @forgeweaver/fw-attachment-local/invariant */

/* jscpd:ignore-start */
import type { Context } from '@forgeweaver/cordis'
import type { InvariantInstaller } from '@forgeweaver/fw-invariants'

const PACKAGE_NAME = '@forgeweaver/fw-attachment-local'
