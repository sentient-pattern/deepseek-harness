...
/**
 * Establish this process's proof that one FW_HOME entry and every ancestor
 ...
 * @param root - absolute `FW_HOME/attachments/v1` root.
...
export async function commitPreparedImageFile(
  ...
  // Establish FW_HOME itself against the filesystem root once per process.
