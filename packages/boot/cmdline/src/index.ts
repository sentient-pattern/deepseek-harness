/**
 * @forgeweaver/fw-cmdline — the command line a fw launcher hands to the app
 * it boots.
 *
 ...
 * verbatim and in argv order. `fw --profile tui --resume abc` yields
 * `['--resume', 'abc']`.
 */
