...
- **`ctx.appExit` is launcher-owned** — booting the headless profile outside the `fw` launcher fails loud at activation until the host provides the exit request.
