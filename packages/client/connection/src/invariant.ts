/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-connection`.
 * @module @forgeweaver/fw-client-connection/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-connection'
