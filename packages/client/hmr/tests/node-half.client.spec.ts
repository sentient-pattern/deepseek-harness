...
import type { WebBootGraph, ClientModuleRegistry } from '@forgeweaver/fw-client-modules'
import type { WebRoute, WebServer } from '@forgeweaver/fw-host-webserver'
...
beforeEach(() => { dir = mkdtempSync(join(tmpdir(), 'fw-hmr-')) })
