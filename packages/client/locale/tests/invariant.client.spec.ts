...
import { apply as nodeApply } from '@forgeweaver/fw-client-locale'
import { apply as clientApply, COMMON_NS, LocaleRuntime, inject } from '@forgeweaver/fw-client-locale/client'
import * as LocaleInvariant from '@forgeweaver/fw-client-locale/invariant'
