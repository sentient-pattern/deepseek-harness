 ...
 * Agent's identity. The mechanism mirrors the host `fw-scope` architecture
...
import type { TypertClientRemote, TypertRemoteScopeApi } from '@forgeweaver/fw-typert-protocol'
...
const kScope = Symbol('fw.client.scope')
