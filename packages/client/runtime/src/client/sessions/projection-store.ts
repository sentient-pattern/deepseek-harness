 ...
 */
import type { SessionProjectionMap } from '@forgeweaver/fw-session-projection/types'
...
// (`/types`, zero imports), never the package root: the root's fw-agent →
// fw-session chain would drag the host `Context.sessions` merge into the
...
export type { SessionProjectionMap } from '@forgeweaver/fw-session-projection/types'
