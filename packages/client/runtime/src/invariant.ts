/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-runtime`.
 * @module @forgeweaver/fw-client-runtime/invariant
 */
...
import type { SlotMap } from '@forgeweaver/fw-client-ui-slots'
import type { InvariantInstaller } from '@forgeweaver/fw-invariants'

const PACKAGE_NAME = '@forgeweaver/fw-client-runtime'
