/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-agent-preset`.
 * @module @forgeweaver/fw-client-ui-agent-preset/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-agent-preset'
