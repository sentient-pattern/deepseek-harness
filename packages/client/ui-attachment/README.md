# @forgeweaver/fw-client-ui-attachment
...
- **Images only** — non-image files have no rail card or history renderer yet; ForgeWeaver Chat-style file cards and upload-progress states wait until the composer accepts non-image attachments.
