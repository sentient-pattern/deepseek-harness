/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-attachment`.
 * @module @forgeweaver/fw-client-ui-attachment/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-attachment'
