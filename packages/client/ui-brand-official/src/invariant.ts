/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-brand-official`.
 * @module @forgeweaver/fw-client-ui-brand-official/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-brand-official'
