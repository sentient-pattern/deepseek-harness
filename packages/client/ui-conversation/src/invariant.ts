/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-conversation`.
 * @module @forgeweaver/fw-client-ui-conversation/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-conversation'
