...
import type { ChatFileMentions, TurnTailOwnerProps } from '@forgeweaver/fw-client-ui-conversation/client'
import { makeTranslate, stubSettingsScope } from '@forgeweaver/fw-client-test-runtime'
import {
...
describe('package shells', () => {
  it('the invariant companion registers ownership', async () => {
    ...
    expect(registered).toEqual(['@forgeweaver/fw-client-ui-deliverables'])
