/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-directory-picker-browse`.
 * @module @forgeweaver/fw-client-ui-directory-picker-browse/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-directory-picker-browse'
