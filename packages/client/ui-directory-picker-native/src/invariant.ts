/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-directory-picker-native`.
 * @module @forgeweaver/fw-client-ui-directory-picker-native/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-directory-picker-native'
