...
import type { GoalSnapshot } from '@forgeweaver/fw-goal/client'
import {
...
export type GoalDockProps = import('@forgeweaver/fw-client-ui-slots').PropsRuntime<'conversation.input.dock'> & GoalBarActions & PropsLocale<'goal'>
