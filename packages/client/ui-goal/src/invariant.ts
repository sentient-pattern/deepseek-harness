/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-goal`.
 * @module @forgeweaver/fw-client-ui-goal/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-goal'
