...
import { ConversationEventRegistry } from '@forgeweaver/fw-client-runtime/src/client/conversation/event-registry.ts'
import type { GoalProjection } from '@forgeweaver/fw-goal/client'
