/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-input-trigger`.
 * @module @forgeweaver/fw-client-ui-input-trigger/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-input-trigger'
