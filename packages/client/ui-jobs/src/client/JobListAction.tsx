...
import type { JobView } from '@forgeweaver/fw-client-runtime/client'
import { IconChevronDownOutline14, StateDot, useDismissOnOutsidePointer, type StateDotState } from '@forgeweaver/fw-client-ui-primitives'
