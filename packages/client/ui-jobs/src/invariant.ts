/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-jobs`.
 * @module @forgeweaver/fw-client-ui-jobs/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-jobs'
