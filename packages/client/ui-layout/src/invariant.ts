/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-layout`.
 * @module @forgeweaver/fw-client-ui-layout/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-layout'
