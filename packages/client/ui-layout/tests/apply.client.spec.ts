...
import { apply as themeApply, inject as themeInject, ThemeRuntime } from '@forgeweaver/fw-client-ui-theme/client'
import { apply, inject, LayoutController } from '@forgeweaver/fw-client-ui-layout/client'
import { apply as nodeApply } from '@forgeweaver/fw-client-ui-layout'
import * as invariant from '@forgeweaver/fw-client-ui-layout/invariant'
...
describe('node half + invariant companion', () => {
  ...
  it('invariant companion registers under the package name', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@forgeweaver/fw-client-ui-layout', expect.any(Function))
