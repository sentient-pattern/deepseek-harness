 ...
 * @module @forgeweaver/fw-client-ui-message-feedback/client/slots
 */
...
import type { MessageId } from '@forgeweaver/fw-client-connection/client'
import type { MessageFeedbackRating } from '@forgeweaver/fw-message-feedback/types'
