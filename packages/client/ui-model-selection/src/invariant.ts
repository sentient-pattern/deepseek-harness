/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-model-selection`.
 * @module @forgeweaver/fw-client-ui-model-selection/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-model-selection'
