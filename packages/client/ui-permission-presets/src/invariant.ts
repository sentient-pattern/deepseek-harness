/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-permission-presets`.
 * @module @forgeweaver/fw-client-ui-permission-presets/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-permission-presets'
