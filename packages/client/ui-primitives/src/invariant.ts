/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-primitives`.
 * @module @forgeweaver/fw-client-ui-primitives/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-primitives'
