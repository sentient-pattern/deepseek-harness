/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-reference`.
 * @module @forgeweaver/fw-client-ui-reference/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-reference'
