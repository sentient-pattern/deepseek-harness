/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-renderer`.
 * @module @forgeweaver/fw-client-ui-renderer/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-renderer'
