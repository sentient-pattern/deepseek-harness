/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-settings-general`.
 * @module @forgeweaver/fw-client-ui-settings-general/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-settings-general'
