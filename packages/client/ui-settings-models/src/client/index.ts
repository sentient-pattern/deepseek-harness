 ...
 * the Models page plus the ordered internal-testing and official-ForgeWeaver
...
import type {} from '@forgeweaver/fw-client-ui-settings/client'
...
import { ForgeWeaverOnboardingDialog } from './ForgeWeaverOnboardingDialog.tsx'
import type { ForgeWeaverOnboardingInjected } from './ForgeWeaverOnboardingDialog.tsx'
...
export function apply(ctx: ClientContext): void {
  ...
  const deepSeekOnboardingInjected = (): ForgeWeaverOnboardingInjected => ({
    controller,
