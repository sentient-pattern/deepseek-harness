/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-settings-models`.
 * @module @forgeweaver/fw-client-ui-settings-models/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-settings-models'
