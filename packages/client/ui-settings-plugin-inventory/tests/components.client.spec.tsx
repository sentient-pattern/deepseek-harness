...
const SNAPSHOT = {
  entries: [
    { entryId: '8a1b2c3d', moduleName: '@forgeweaver/cordis-plugin-hmr', enabled: true, fiberPhase: 'active' },
    ...
    { entryId: 'disabled-entry', moduleName: '@forgeweaver/fw-host-directory-picker-native', enabled: false, fiberPhase: null },
  ],
