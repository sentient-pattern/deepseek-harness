/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-settings-plugins`.
 * @module @forgeweaver/fw-client-ui-settings-plugins/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-settings-plugins'
