...
import * as PluginConfigInvariant from '@forgeweaver/fw-client-ui-settings-plugins/invariant'
...
describe('invariant companion', () => {
  ...
  it('has an empty node half', async () => {
    const { apply } = await import('@forgeweaver/fw-client-ui-settings-plugins')
