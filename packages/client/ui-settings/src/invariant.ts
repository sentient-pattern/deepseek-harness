/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-settings`.
 * @module @forgeweaver/fw-client-ui-settings/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-settings'
