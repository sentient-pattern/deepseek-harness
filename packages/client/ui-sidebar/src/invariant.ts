/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-sidebar`.
 * @module @forgeweaver/fw-client-ui-sidebar/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-sidebar'
