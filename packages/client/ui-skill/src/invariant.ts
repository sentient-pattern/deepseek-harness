/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-skill`.
 * @module @forgeweaver/fw-client-ui-skill/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-skill'
