/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-slots`.
 * @module @forgeweaver/fw-client-ui-slots/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-slots'
