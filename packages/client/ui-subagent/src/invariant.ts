/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-subagent`.
 * @module @forgeweaver/fw-client-ui-subagent/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-subagent'
