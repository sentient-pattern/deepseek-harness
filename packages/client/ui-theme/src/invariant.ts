/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-theme`.
 * @module @forgeweaver/fw-client-ui-theme/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-theme'
