...
const INDIRECTION_PREFIX = '--fw-scrollbar-'
...
const ELEVATED_REBIND = new Map([
  ['--fw-scrollbar-thumb', '--dsw-alias-scrollbar-bg-l2'],
  ['--fw-scrollbar-thumb-hover', '--dsw-alias-scrollbar-hover-l2'],
...
describe('scrollbar.css width variable', () => {
  ...
  it('every reader of the width variable outside ui-theme references a defined variable', () => {
    ...
    // (`right: var(--fw-scrollbar-width)`); a rename in scrollbar.css without
