 ...
 * ({@link module:@forgeweaver/fw-tools/src/presentation}). This derivation
 ...
 * @module
 */
import type { SearchBlockProps, SearchFileGroup } from '@forgeweaver/fw-client-ui-primitives'
