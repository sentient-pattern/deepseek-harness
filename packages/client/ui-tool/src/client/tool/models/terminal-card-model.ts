 ...
 * @module
 */
import { resolveWorkspacePath } from '@forgeweaver/fw-client-runtime/client'
import type { TerminalBlockLabels, TerminalBlockProps } from '@forgeweaver/fw-client-ui-primitives'
import type { TranslateNS } from '@forgeweaver/fw-client-ui-slots'
 ...
 * `ToolResultNode.call`/`callView` in fw-client-runtime), leaving a terminal
