/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-tool`.
 * @module @forgeweaver/fw-client-ui-tool/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-tool'
