...
import type { ToolResultView } from '@forgeweaver/fw-api-remotes/client'
import { bindSnapshotSelector } from '@forgeweaver/fw-client-test-runtime'
import type { SelectionTarget } from '@forgeweaver/fw-client-ui-conversation/client'
import type { ToolCallOwnerProps } from '@forgeweaver/fw-client-ui-tool/client'
import { IconGlobeOutline14 } from '@forgeweaver/fw-client-ui-primitives'
...
import { DetailsPanel } from '@forgeweaver/fw-client-ui-conversation/src/client/skeleton/DetailsPanel.tsx'
...
import { zh } from '@forgeweaver/fw-client-ui-conversation/src/client/locales.ts'
...
const SEARCH_ARGS = '{"query":"forgeweaver harness"}'
...
describe('web toolview registration', () => {
  it('registers one WebRow under both web_search and web_fetch', () => {
    ...
    } as unknown as import('@forgeweaver/cordis').Context
