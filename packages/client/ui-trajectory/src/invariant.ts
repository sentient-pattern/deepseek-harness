/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-trajectory`.
 * @module @forgeweaver/fw-client-ui-trajectory/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-trajectory'
