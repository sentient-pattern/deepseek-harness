 ...
 * not built (`pnpm --filter @forgeweaver/fw-client-ui-trajectory bundle`).
 */
...
const PLUGIN_ID = '@forgeweaver/fw-client-ui-trajectory'
...
describe('tsdown client artifact', () => {
  ...
  async function loadArtifact() {
    ...
    const modules = new Map<string, unknown>([
      ...
      ['@forgeweaver/fw-client-runtime/client', await import('@forgeweaver/fw-client-runtime/client')],
      ['@forgeweaver/fw-client-ui-primitives', await import('@forgeweaver/fw-client-ui-primitives')],
    ])
  ...
  it.skipIf(code === undefined)('mounted as an object plugin, apply registers the view tab on the real ring', async () => {
    ...
    const locale = await import('@forgeweaver/fw-client-locale/client')
