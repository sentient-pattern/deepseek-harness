/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-user-questions`.
 * @module @forgeweaver/fw-client-ui-user-questions/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-user-questions'
