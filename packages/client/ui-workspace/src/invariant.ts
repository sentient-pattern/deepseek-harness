/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-workspace`.
 * @module @forgeweaver/fw-client-ui-workspace/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-workspace'
