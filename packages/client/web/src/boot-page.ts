 ...
 * @module @forgeweaver/fw-client-web/src/boot-page
 */
...
export class BootPage {
  ...
  constructor(container: HTMLElement) {
    ...
    this.root.dataset.fwBoot = ''
    this.card = div(css.card)
    this.wordmark = div(css.wordmark, 'HARNESS')
    this.spinner = div(css.spinner)
    this.spinner.dataset.fwBootSpinner = ''
  ...
  private updateProgress(): void {
    ...
    this.spinner.style.setProperty('--fw-boot-arc', `${String(Math.round(72 + ratio * 216))}deg`)
  }
}
