/**
 * Package-owned invariant companion for `@forgeweaver/fw-code-runtime-python`.
 * @module @forgeweaver/fw-code-runtime-python/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-code-runtime-python'
