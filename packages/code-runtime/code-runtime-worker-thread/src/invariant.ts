/**
 * Package-owned invariant companion for `@forgeweaver/fw-code-runtime-worker-thread`.
 * @module @forgeweaver/fw-code-runtime-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-code-runtime-worker-thread'
