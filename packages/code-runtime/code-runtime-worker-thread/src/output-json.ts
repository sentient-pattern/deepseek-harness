/** JSON string-prefix accounting for the outer-output ledger. @module @forgeweaver/fw-code-runtime-worker-thread/output-json */

import type { CodeJsonValue } from '@forgeweaver/fw-code-runtime'
