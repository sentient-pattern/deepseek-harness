 ...
 * @module @forgeweaver/fw-code-runtime-worker-thread/src/worker
 */
...
if (!parentPort) throw new Error('fw-code-runtime-worker-thread: worker entry loaded outside a worker thread')
