/**
 * Package-owned invariant companion for `@forgeweaver/fw-command-compact`.
 * @module @forgeweaver/fw-command-compact/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-command-compact'
