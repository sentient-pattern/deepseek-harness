...
import * as invariant from '@forgeweaver/fw-command-compact/invariant'
...
describe('command-compact invariant companion', () => {
  it('registers the package-owned no-op installer', async () => {
    ...
    expect(register).toHaveBeenCalledWith('@forgeweaver/fw-command-compact', expect.any(Function))
    expect(() => {
