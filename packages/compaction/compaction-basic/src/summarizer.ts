 ...
 *
 * @module @forgeweaver/fw-compaction-basic/summarizer
 */

import type { Context } from '@forgeweaver/cordis'
import { contentHasImage, createUserMessage, BlockAssembler, LlmError } from '@forgeweaver/fw-llm'
import type {
...
export async function summarizeWithLlm(
  ...
  const messages: Message[] = [
    ...
    createUserMessage({
      ...
      source: { kind: 'plugin', plugin: 'fw-compaction-basic' },
    }),
  ]
