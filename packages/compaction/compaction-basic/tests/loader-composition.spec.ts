...
async function loadYaml(lines: readonly string[]): Promise<Context> {
  root = await mkdtemp(join(tmpdir(), 'fw-token-meter-loader-'))
  ...
  const modules = new Map<string, unknown>([
    ...
    ['@forgeweaver/fw-token-meter', TokenMeter],
    ['@forgeweaver/fw-compaction-tool-result-pruner', ToolResultPruner],
    ['@forgeweaver/fw-compaction-basic', BasicCompactionEngine],
  ])
