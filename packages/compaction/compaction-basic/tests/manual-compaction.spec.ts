...
import * as CompactionInvariant from '@forgeweaver/fw-compaction/invariant'
import * as CompactionBasicInvariant from '@forgeweaver/fw-compaction-basic/invariant'
import { BasicCompactionEngine } from '@forgeweaver/fw-compaction-basic'
import { CompactionId, isCompactCheckpointSource, ManualCompactionError } from '@forgeweaver/fw-compaction'
...
import SessionStore, { Session, SessionId, type SessionEvent } from '@forgeweaver/fw-session'
...
import type {
  SummarizationInput,
  SummaryResult,
} from '@forgeweaver/fw-compaction-basic/src/summarizer.ts'
