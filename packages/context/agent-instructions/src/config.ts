 ...
 *
 * @module @forgeweaver/fw-agent-instructions/config
 */
...
export function resolveDiscoveryConfig(
  config: Pick<Config, 'fwHome' | 'projectRootMarkers' | 'instructionFileCandidates' | 'localInstructionFileCandidates'>,
): ResolvedDiscoveryConfig {
  return {
    fwHome: resolveDshHome(config.fwHome),
