 ...
 * mount it as a no-op.
 *
 * @module @forgeweaver/fw-agent-instructions
 */
...
import type { ToolExecution, ToolExecutionResult, ToolExecutionToken } from '@forgeweaver/fw-tools'
