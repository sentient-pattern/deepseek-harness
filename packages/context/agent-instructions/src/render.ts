 ...
 *
 * @module @forgeweaver/fw-agent-instructions/render
 */
...
/**
 * File name of the single user-global instruction file under `$FW_HOME`.
 * Discovery (`$FW_HOME/<name>`) and reconciliation (the user-global scope key's
...
export function scopeForDisplayPath(displayPath: string): string {
  if (displayPath === '~/.fw/AGENTS.md' || displayPath === '$FW_HOME/AGENTS.md') return USER_GLOBAL_DIRECTORY
