/**
 * Package-owned invariant companion for `@forgeweaver/fw-file-reference-local`.
 * @module @forgeweaver/fw-file-reference-local/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-file-reference-local'
