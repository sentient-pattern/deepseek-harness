/**
 * Package-owned invariant companion for `@forgeweaver/fw-file-reference`.
 * @module @forgeweaver/fw-file-reference/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-file-reference'
