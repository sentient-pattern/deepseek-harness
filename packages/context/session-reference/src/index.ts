 ...
 *
 * @module @forgeweaver/fw-session-reference
 */

import { Context } from '@forgeweaver/cordis'
import z from '@forgeweaver/schemastery'
import type { Agent, PreStepDecision } from '@forgeweaver/fw-agent'
import { Remote, TypertRemoteService } from '@forgeweaver/fw-typert-protocol'
import { createUserMessage, freezeMessage } from '@forgeweaver/fw-llm'
import type { ContentBlock, UserMessage } from '@forgeweaver/fw-llm'
import type { SessionId } from '@forgeweaver/fw-session'
import type { SessionSurfaceSnapshot, SessionTitleObservationResult } from '@forgeweaver/fw-session-query'
import {
