/**
 * Package-owned invariant companion for `@forgeweaver/fw-session-reference`.
 * @module @forgeweaver/fw-session-reference/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-session-reference'
