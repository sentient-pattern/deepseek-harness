 ...
 * @module @forgeweaver/fw-session-reference/types
 */

import type { UserMessage } from '@forgeweaver/fw-llm/message'
...
export interface SessionReferenceMentionCandidate extends SessionReferenceCandidate {
  /** Canonical `@[label](fw-session:…)` mention serialized into the prompt draft. */
  mention: string
}
