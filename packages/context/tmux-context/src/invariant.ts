/**
 * Package-owned invariant companion for `@forgeweaver/fw-tmux-context`.
 * @module @forgeweaver/fw-tmux-context/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-tmux-context'
