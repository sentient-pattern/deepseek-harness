 ...
 * @module @forgeweaver/fw-agent-loop/invariant
 */

import type { Context } from '@forgeweaver/cordis'
import { isAgentLoopRequest, type GenerateOptions } from '@forgeweaver/fw-llm'
import type { InvariantFailure, InvariantInstaller } from '@forgeweaver/fw-invariants'
import { foldRequestHeader } from '@forgeweaver/fw-session'

const PACKAGE_NAME = '@forgeweaver/fw-agent-loop'
