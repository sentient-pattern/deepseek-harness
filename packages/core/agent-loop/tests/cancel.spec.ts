import { CallId, createUserMessage } from '@forgeweaver/fw-llm'
/**
 ...
 * @module fw-agent-loop/tests/cancel
 */
...
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED_BEFORE_DISPATCH } from '@forgeweaver/fw-tools'
...
describe('Agent.cancel()', () => {
  ...
  it('cancel during error recovery does not finalize the failed stream', async () => {
    ...
    // fw-llm-retry opens when its backoff waits after appending llm/retry.
