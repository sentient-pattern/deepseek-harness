/**
 * Package-owned invariant companion for `@forgeweaver/fw-agent-tool-presentation`.
 * @module @forgeweaver/fw-agent-tool-presentation/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-agent-tool-presentation'
 ...
 * registry's to hold, and `fw-tools` observes it there.
 */
