/** Package-owned scoped-dispatch invariants. @module @forgeweaver/fw-scope/invariant */

import type { Context } from '@forgeweaver/cordis'
import type { InvariantInstaller } from '@forgeweaver/fw-invariants'
import { carrierKeyOf, isScopeCarrier } from '@forgeweaver/fw-scope'
import { scopedSubjectResolverFor } from './scoped-events.generated.ts'

const PACKAGE_NAME = '@forgeweaver/fw-scope'
