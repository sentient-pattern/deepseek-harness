 ...
 *
 * @module @forgeweaver/fw-session
 */

import { Context, Service } from '@forgeweaver/cordis'
import { isAbsolute } from 'node:path'
import { deepFreeze } from '@forgeweaver/fw-llm'
import { scopeOf, scopeTarget } from '@forgeweaver/fw-scope'
import type { Scoped } from '@forgeweaver/fw-scope'
import type { Message } from '@forgeweaver/fw-llm'
import { SESSION_FORMAT_VERSION, SessionId } from './types.ts'
import type { TypertLookup } from '@forgeweaver/fw-typert-protocol'
...
export type { AssistantMessage, ToolResultMessage, UserMessage } from '@forgeweaver/fw-llm'
  ...
  constructor(ctx: Context) {
    ...
    ctx.inject(['typert'], (typeCtx) => {
      typeCtx.typert.lookups.register('session', {
        parameter: 'session',
        wire: 'sessionId',
        hostTypeSymbol: '@forgeweaver/fw-session#Session',
        wireTypeSymbol: '@forgeweaver/fw-session/types#SessionId',
