...
| Key | Default | Meaning |
|---|---|---|
| `includeHarnessIdentity` | `true` | Include the fixed `You are an AI agent powered by ForgeWeaver.` order-−100 opener. Set false only when a compatibility deployment owns the complete system prompt. |
