...
import { createScope, scopeOf } from '@forgeweaver/fw-scope'
import type { Scope, ScopeKey } from '@forgeweaver/fw-scope'
import SystemPrompt, { TOOL_ORDER_REST, renderContextSnapshot, renderPrompt } from '@forgeweaver/fw-system-prompt'
import type { Config, PromptAssembly } from '@forgeweaver/fw-system-prompt'
