/**
 * Package-owned invariant companion for `@forgeweaver/fw-authorization`.
 * @module @forgeweaver/fw-authorization/invariant
 */

import type { Context } from '@forgeweaver/cordis'
import type { InvariantFailure, InvariantInstaller } from '@forgeweaver/fw-invariants'

const PACKAGE_NAME = '@forgeweaver/fw-authorization'
