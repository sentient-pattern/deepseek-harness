...
const KEY = credentialRef('FW_CRED_PIPE')
...
async function tempDir(): Promise<string> {
  const dir = await mkdtemp(join(tmpdir(), 'fw-credentials-watch-'))
