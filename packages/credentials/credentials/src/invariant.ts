/**
 * Package-owned invariant companion for `@forgeweaver/fw-credentials`.
 * @module @forgeweaver/fw-credentials/invariant
 */

import type { Context } from '@forgeweaver/cordis'
import type { InvariantFailure, InvariantInstaller } from '@forgeweaver/fw-invariants'

const PACKAGE_NAME = '@forgeweaver/fw-credentials'
