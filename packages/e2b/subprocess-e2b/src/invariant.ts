/**
 * Package-owned invariant companion for `@forgeweaver/fw-subprocess-e2b`.
 * @module @forgeweaver/fw-subprocess-e2b/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-subprocess-e2b'
