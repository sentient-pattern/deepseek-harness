 ...
 * ({@link @forgeweaver/fw-agent-spine-demo}), JSONL session persistence, and
 * the {@link @forgeweaver/fw-acp} bridge. The app owns those plugins through one
 ...
 * @module @forgeweaver/fw-acp-demo
 */

import type { Context } from '@forgeweaver/cordis'
import { join } from 'node:path'
import z from '@forgeweaver/schemastery'
import * as acp from '@forgeweaver/fw-acp'
...
} from '@forgeweaver/fw-session-persistence-jsonl'
...
export const Config: z<Config> = z.object({
  ...
  // order" (the owning fw-system-prompt schema does the same), while
