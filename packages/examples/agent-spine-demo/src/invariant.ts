/**
 * Package-owned invariant companion for `@forgeweaver/fw-agent-spine-demo`.
 * @module @forgeweaver/fw-agent-spine-demo/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-agent-spine-demo'
