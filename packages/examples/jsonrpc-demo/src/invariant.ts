/**
 * Package-owned invariant companion for `@forgeweaver/fw-sdk-jsonrpc-demo`.
 * @module @forgeweaver/fw-sdk-jsonrpc-demo/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-sdk-jsonrpc-demo'
