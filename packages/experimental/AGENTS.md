...
- Every package here uses the `@forgeweaver/fw-experimental-*` npm prefix, sets `private: true`, and omits `publishConfig`; the workspace constraints gate enforces these declarations and the fw release family excludes this directory.
