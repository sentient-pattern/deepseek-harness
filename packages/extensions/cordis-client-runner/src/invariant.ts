/**
 * Package-owned invariant companion for `@forgeweaver/fw-cordis-client-runner`.
 * @module @forgeweaver/fw-cordis-client-runner/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-cordis-client-runner'
