/**
 * Package-owned invariant companion for `@forgeweaver/fw-cordis-host-runner`.
 * @module @forgeweaver/fw-cordis-host-runner/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-cordis-host-runner'
