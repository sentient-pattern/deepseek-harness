/**
 * Package-owned invariant companion for `@forgeweaver/fw-tool-cordis`.
 * @module @forgeweaver/fw-tool-cordis/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-tool-cordis'
