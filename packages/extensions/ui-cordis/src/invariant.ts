/**
 * Package-owned invariant companion for `@forgeweaver/fw-client-ui-cordis`.
 * @module @forgeweaver/fw-client-ui-cordis/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-client-ui-cordis'
