 ...
 * @module @forgeweaver/fw-message-feedback
 */

import { Buffer } from 'node:buffer'
import { randomUUID } from 'node:crypto'
import { Context, Service } from '@forgeweaver/cordis'
import s from '@forgeweaver/schemastery'
import { deriveEventMessage, isAppendSurfaceEvent } from '@forgeweaver/fw-session/surface'
import type { SessionHeader, SessionId } from '@forgeweaver/fw-session/types'
import type { SessionInspection } from '@forgeweaver/fw-session-persistence'
