 ...
 * streams large files, and rejects binary data; line windows belong to `fw-tool-fs`. Writes
 * stage an exclusive owner-only file in a private sibling directory and atomically publish it.
 * @module @forgeweaver/fw-fs-local/fsio
 */
...
import { FsError, FsTargetKey, FsVersion } from '@forgeweaver/fw-fs'
