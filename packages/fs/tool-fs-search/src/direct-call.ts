/** Shared top-level-call post-policy selection for search result spill. @module fw-tool-fs-search/direct-call */

import type { Context } from '@forgeweaver/cordis'
import type { JsonValue, PostToolDecision, ToolDefinition, ToolExecution, ToolExecutionResult } from '@forgeweaver/fw-tools'
