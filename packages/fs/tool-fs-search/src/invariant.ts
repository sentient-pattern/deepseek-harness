/**
 * Package-owned invariant companion for `@forgeweaver/fw-tool-fs-search`.
 * @module @forgeweaver/fw-tool-fs-search/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-tool-fs-search'
