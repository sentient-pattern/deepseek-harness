...
The generated [`str_replace_editor` schema](../../../docs/tool-catalog.md#forgeweaverfw-tool-str-replace-editor), including the configured `description`. The plugin contributes no standalone system-prompt section.
