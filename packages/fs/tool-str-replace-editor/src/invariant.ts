/**
 * Package-owned invariant companion for `@forgeweaver/fw-tool-str-replace-editor`.
 * @module @forgeweaver/fw-tool-str-replace-editor/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-tool-str-replace-editor'
