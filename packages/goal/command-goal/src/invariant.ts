/**
 * Package-owned invariant companion for `@forgeweaver/fw-command-goal`.
 * @module @forgeweaver/fw-command-goal/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-command-goal'
