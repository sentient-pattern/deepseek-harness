# @forgeweaver/fw-goal-round-driver
...
```yaml
- id: goal
  name: '@forgeweaver/fw-goal'

- id: tool-goal
  name: '@forgeweaver/fw-tool-goal'

- id: goal-round-driver
  name: '@forgeweaver/fw-goal-round-driver'
```

The plugin has no tunable configuration. `maxGoalRounds` belongs to the goal definition, while the model-facing blocked threshold belongs to [`fw-tool-goal`](../tool-goal/README.md); duplicating either value in the driver could produce divergent policy.
