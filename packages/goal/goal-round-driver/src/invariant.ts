/** Package-owned goal-round prompt invariants. @module @forgeweaver/fw-goal-round-driver/invariant */

import { isDeepStrictEqual } from 'node:util'
import type { Context } from '@forgeweaver/cordis'
import { foldGoal, type FoldedGoal, type GoalMessageSource, type GoalView } from '@forgeweaver/fw-goal'
...
const PACKAGE_NAME = '@forgeweaver/fw-goal-round-driver'
