...
import AgentRegistry, { agentEvents, Inbox } from '@forgeweaver/fw-agent'
import type { Agent } from '@forgeweaver/fw-agent'
import { createUserMessage, HarnessError } from '@forgeweaver/fw-llm'
import SessionStore, { Session, SessionId, type UserMessage } from '@forgeweaver/fw-session'
import GoalService, {
  GoalError,
  GoalId,
  decodeGoalChange,
...
import type { GoalChangeMeta, GoalRef, GoalSnapshotChangeMeta } from '@forgeweaver/fw-goal'
...
function stubAgent(rawId: string, seed?: readonly import('@forgeweaver/fw-session').SessionEvent[]): StubAgent {
