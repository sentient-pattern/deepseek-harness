 ...
 * @module @forgeweaver/fw-tool-goal
 */

import type { Context } from '@forgeweaver/cordis'
import z from '@forgeweaver/schemastery'
import { GoalId } from '@forgeweaver/fw-goal'
import type { GoalRef, GoalView } from '@forgeweaver/fw-goal'
import { boundContextSummary, createUserMessage, HarnessError } from '@forgeweaver/fw-llm'
import { defineTool } from '@forgeweaver/fw-tools'
import type { GenericCallView } from '@forgeweaver/fw-tools'
