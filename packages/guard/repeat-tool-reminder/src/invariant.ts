/**
 * Package-owned invariant companion for `@forgeweaver/fw-repeat-tool-reminder`.
 * @module @forgeweaver/fw-repeat-tool-reminder/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-repeat-tool-reminder'
