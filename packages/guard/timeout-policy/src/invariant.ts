/**
 * Package-owned invariant companion for `@forgeweaver/fw-tool-call-timeout-policy`.
 * @module @forgeweaver/fw-tool-call-timeout-policy/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-tool-call-timeout-policy'
