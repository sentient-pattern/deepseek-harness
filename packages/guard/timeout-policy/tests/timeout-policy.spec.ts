/**
 * Unit + real-load-path coverage for @forgeweaver/fw-tool-call-timeout-policy. The
...
import { CallId, HarnessError } from '@forgeweaver/fw-llm'
import SystemPrompt from '@forgeweaver/fw-system-prompt'
import ToolRuntime, { defineContentToolFixture, TOOL_ABORTED, type ToolExecutionInput, type PostToolDecision } from '@forgeweaver/fw-tools'
import * as timeoutPolicy from '@forgeweaver/fw-tool-call-timeout-policy'
import { TOOL_TIMEOUT } from '@forgeweaver/fw-tool-call-timeout-policy'
...
describe('fw-tool-call-timeout-policy real-load-path guard', () => {
