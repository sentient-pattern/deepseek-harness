/**
 * Package-owned invariant companion for `@forgeweaver/fw-hooks-claude-code`.
 * @module @forgeweaver/fw-hooks-claude-code/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-hooks-claude-code'
