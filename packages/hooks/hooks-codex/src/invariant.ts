/**
 * Package-owned invariant companion for `@forgeweaver/fw-hooks-codex`.
 * @module @forgeweaver/fw-hooks-codex/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-hooks-codex'
