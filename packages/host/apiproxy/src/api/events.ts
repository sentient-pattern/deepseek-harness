...
import type { AskUserQuestionItem } from '@forgeweaver/fw-user-questions/types'
import type { ApprovalOutcome, ApprovalRequestId } from '@forgeweaver/fw-user-approval/types'
import type { Message } from '@forgeweaver/fw-llm/types'
import type { MessageId } from '@forgeweaver/fw-llm/brand'
import type { CallId } from '@forgeweaver/fw-llm/brand'
import type { JsonValue, SessionEvent, SessionId } from '@forgeweaver/fw-session/types'
import type { ToolCallView, ToolResultView } from '@forgeweaver/fw-tools/presentation'
import type { RpcError, RpcId, RpcRequest } from './rpc.ts'
import type { JobView } from './jobs.ts'
import type { WorkspaceView } from './workspace.ts'

// Client-side consumers take the render-intent vocabulary from the contract;
// fw-tools remains its owner.
...
export type HostFrame =
   ...
   * owned by `@forgeweaver/fw-api-remotes` (`API_REMOTE_FORWARDED_EVENTS`),
