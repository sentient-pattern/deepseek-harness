/**
 * Package-owned invariant companion for `@forgeweaver/fw-host-apiproxy`.
 * @module @forgeweaver/fw-host-apiproxy/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-host-apiproxy'
