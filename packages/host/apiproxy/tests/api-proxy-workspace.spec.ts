...
import type { Agent, AgentFactory } from '@forgeweaver/fw-agent'
...
import type { DirectoryPickerCapability } from '@forgeweaver/fw-host-directory-picker'
import WorkspaceRegistry from '@forgeweaver/fw-workspace'
import type { HostFrame, WorkspaceId } from '@forgeweaver/fw-host-apiproxy/api'
import type { RpcRequest, RpcResponse } from '@forgeweaver/fw-host-apiproxy/api/rpc'
...
async function harness(
  root = realpathSync.native(mkdtempSync(join(tmpdir(), 'fw-apiproxy-workspace-'))),
