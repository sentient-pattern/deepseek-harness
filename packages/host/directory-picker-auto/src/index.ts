 ...
 * @module @forgeweaver/fw-host-directory-picker-auto
 */
...
export const BACKEND_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@forgeweaver/fw-host-directory-picker-native',
  browse: '@forgeweaver/fw-host-directory-picker-browse',
}
...
export const SURFACE_PACKAGES: Record<DirectoryPickerBackendKind, string> = {
  native: '@forgeweaver/fw-client-ui-directory-picker-native',
  browse: '@forgeweaver/fw-client-ui-directory-picker-browse',
}
