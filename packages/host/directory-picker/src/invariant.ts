/** Package-owned invariant companion for the directory-picker seam. @module @forgeweaver/fw-host-directory-picker/invariant */

import type { Context } from '@forgeweaver/cordis'
import type { InvariantInstaller } from '@forgeweaver/fw-invariants'

const PACKAGE_NAME = '@forgeweaver/fw-host-directory-picker'
