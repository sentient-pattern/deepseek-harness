/**
 * Package-owned invariant companion for `@forgeweaver/fw-host-frontend-static`.
 * @module @forgeweaver/fw-host-frontend-static/invariant
 */

import type { Context } from '@forgeweaver/cordis'
import type { InvariantInstaller } from '@forgeweaver/fw-invariants'

const PACKAGE_NAME = '@forgeweaver/fw-host-frontend-static'
