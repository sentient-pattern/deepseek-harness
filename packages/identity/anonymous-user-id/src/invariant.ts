/**
 * Package-owned invariant companion for `@forgeweaver/fw-anonymous-user-id`.
 * @module @forgeweaver/fw-anonymous-user-id/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-anonymous-user-id'
