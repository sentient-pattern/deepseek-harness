/**
 * fw-commands' owned branded id: command lifecycle pairing across the
 * session log, the wire admission response, and client-side flow pairing.
 *
 * The `Branded<B>` primitive lives in `@forgeweaver/fw-brand`; this module
 ...
 * loading the host plugin's Context merges — the `fw-llm/brand` shape.
 *
 * @module @forgeweaver/fw-commands/brand
 */
