/** Package-owned permission-preset event invariants. @module @forgeweaver/fw-permission-presets/invariant */
...
const PACKAGE_NAME = '@forgeweaver/fw-permission-presets'
