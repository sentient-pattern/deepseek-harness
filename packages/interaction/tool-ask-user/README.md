...
The model sees the generated [`ask_user_question` schema](../../../docs/tool-catalog.md#forgeweaverfw-tool-ask-user), including question ids, prompts, headings, options, and multi-select flags.
