/**
 * Package-owned invariant companion for `@forgeweaver/fw-user-questions`.
 * @module @forgeweaver/fw-user-questions/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-user-questions'
