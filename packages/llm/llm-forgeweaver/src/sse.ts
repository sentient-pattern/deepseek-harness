 ...
 * ForgeWeaver protocol: the literal `[DONE]` is yielded so the caller owns final
 ...
 *
 * @module fw-llm-forgeweaver/sse
 */

import { EventSourceParserStream } from 'eventsource-parser/stream'
import { LlmError } from '@forgeweaver/fw-llm'

/** The terminal payload ForgeWeaver (and OpenAI) send after the last chunk. */
