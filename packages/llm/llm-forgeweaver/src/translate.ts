/**
 * Translate ForgeWeaver SSE payloads with one stateful harness block per content, reasoning, or tool
 ...
 *
 * Translate ForgeWeaver wire chunks into the harness `StreamChunk` protocol.
 * @module fw-llm-forgeweaver/translate
 */

import { CallId, EMPTY_RESPONSE_CODE, LlmError } from '@forgeweaver/fw-llm'
import type { ContentBlock, FinishReason, StreamChunk, TokenUsage } from '@forgeweaver/fw-llm'
...
/**
 * Map wire usage fields. ForgeWeaver's `prompt_tokens` INCLUDES cache hits
