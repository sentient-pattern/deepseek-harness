/**
 * ForgeWeaver chat-completions wire format (OpenAI-compatible). Types only.
 *
 ...
 *
 * @module fw-llm-forgeweaver/types
 */
...
export interface WireAssistantMessage {
   ...
   * guides/thinking_mode.mdx § Tool Calls); ForgeWeaver ignores it elsewhere,
