...
import type { ImageAttachmentRef, ImageMediaType, RequestImageAttachment } from '@forgeweaver/fw-attachment'
import { createUserMessage, CallId, ReasoningEffortId, createMessage } from '@forgeweaver/fw-llm'
...
function request(overrides: Partial<GenerateOptions> = {}): GenerateOptions {
  return { provider: 'forgeweaver-official', model: 'forgeweaver-v4-flash', messages: [], ...overrides }
}
...
describe('serializeRequest', () => {
  ...
  it('rejects an effort outside the ForgeWeaver capability', () => {
