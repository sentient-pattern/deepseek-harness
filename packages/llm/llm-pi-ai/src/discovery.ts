 ...
 *
 * @module fw-llm-pi-ai/discovery
 */

import { INVALID_CREDENTIAL_CODE, LlmError, normalizeApiKey } from '@forgeweaver/fw-llm'
import type { LlmDiscoveredModel, LlmModelDiscoveryRequest } from '@forgeweaver/fw-llm'
import { attributionHeaders } from '@forgeweaver/fw-llm'
 ...
 * on the length the server claims — the same two-stage shape `fw-web-fetch`
