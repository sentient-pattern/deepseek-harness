 ...
 * @module fw-llm/call-config
 */

import type { GenerateOptions } from './types.ts'
import type { ReasoningEffortId } from './brand.ts'

/** Process-local identities of request objects assembled by fw-agent-loop. */
...
/**
 * Mark one exact request object as assembled by fw-agent-loop.
...
/**
 * Test whether the exact request object was assembled by fw-agent-loop.
