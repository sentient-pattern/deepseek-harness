/**
 * Package-owned invariant companion for `@forgeweaver/fw-token-meter`.
 * @module @forgeweaver/fw-token-meter/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-token-meter'
