...
| `timeoutMs` | `60000` | Tool-call timeout budget, enforced by `fw-tool-call-timeout-policy`; covers the complete queued open/query/close lifecycle and is not model-configurable. |
...
The model sees the generated [`lsp` schema](../../../docs/tool-catalog.md#forgeweaverfw-tool-lsp).
