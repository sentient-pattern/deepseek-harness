/**
 * Real-load-path guard for @forgeweaver/fw-mcp-client. `mcp-client` is a
...
import * as mcpClient from '@forgeweaver/fw-mcp-client'

describe('fw-mcp-client real-load-path guard', () => {
