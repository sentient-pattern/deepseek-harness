...
import ToolRuntime, { RUN_CODE_NAME, defineContentToolFixture } from '@forgeweaver/fw-tools'
import { Session, SessionId, type UserMessage } from '@forgeweaver/fw-session'
import AgentRegistry, { agentEvents, type Agent } from '@forgeweaver/fw-agent'
...
import { CodeRuntime, type CodeRunRequest, type CodeRunResult } from '@forgeweaver/fw-code-runtime'
...
/**
 * Drives the REAL plugin: mounts `fw-plan-mode` beside real `SystemPrompt` and
