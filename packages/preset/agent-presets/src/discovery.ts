 ...
 * @module @forgeweaver/fw-agent-presets/discovery
 */
...
import { expandHomePath } from '@forgeweaver/fw-home-paths'
 ...
 *
 * This package owns the writable root the way `fw-skill-filesystem` owns
 * `<fwHome>/skills`. An app must assemble the SHIPPED root, whose path only
