...
import AgentRegistry, { assembleContextFor } from '@forgeweaver/fw-agent'
import AgentLoop from '@forgeweaver/fw-agent-loop'
import InvariantRegistry from '@forgeweaver/fw-invariants'
import { describe, expect, it } from 'vitest'
import AgentPresets, { livePresetMounts, type Config } from '@forgeweaver/fw-agent-presets'
import * as AgentPresetsInvariant from '@forgeweaver/fw-agent-presets/invariant'
