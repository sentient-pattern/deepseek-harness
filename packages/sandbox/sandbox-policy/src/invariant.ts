/** Package-owned session-event invariants for sandbox policy. @module @forgeweaver/fw-sandbox-policy/invariant */
...
const PACKAGE_NAME = '@forgeweaver/fw-sandbox-policy'
