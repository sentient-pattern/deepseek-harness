 ...
 * (`@forgeweaver/fw-sandbox-local`) and the in-process filesystem fence
 * (`@forgeweaver/fw-fs-sandbox`) both derive their allow-list here, so "the
