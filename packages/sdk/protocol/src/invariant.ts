/**
 * Package-owned invariant companion for `@forgeweaver/fw-sdk-protocol`.
 * @module @forgeweaver/fw-sdk-protocol/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-sdk-protocol'
