...
- **Automatic adapter mounting is ForgeWeaver-specific** — `initialize` can reuse any pre-registered model adapter, but its only fallback mounts `fw-llm-forgeweaver`.
