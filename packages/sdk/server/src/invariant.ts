/**
 * Package-owned invariant companion for `@forgeweaver/fw-sdk-jsonrpc-server`.
 * @module @forgeweaver/fw-sdk-jsonrpc-server/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-sdk-jsonrpc-server'
