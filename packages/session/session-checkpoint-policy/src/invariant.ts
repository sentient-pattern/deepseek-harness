/**
 * Package-owned invariant companion for `@forgeweaver/fw-session-checkpoint-policy`.
 * @module @forgeweaver/fw-session-checkpoint-policy/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-session-checkpoint-policy'
