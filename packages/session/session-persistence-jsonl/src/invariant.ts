/**
 * Package-owned invariant companion for `@forgeweaver/fw-session-persistence-jsonl`.
 * @module @forgeweaver/fw-session-persistence-jsonl/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-session-persistence-jsonl'
