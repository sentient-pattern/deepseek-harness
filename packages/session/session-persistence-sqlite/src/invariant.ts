/**
 * Package-owned invariant companion for `@forgeweaver/fw-session-persistence-sqlite`.
 * @module @forgeweaver/fw-session-persistence-sqlite/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-session-persistence-sqlite'
