 ...
 * @module @forgeweaver/fw-session-persistence/coordinator
 */
...
import type { Session, SessionEvent, SessionId, SessionHeader } from '@forgeweaver/fw-session'
...
export class PersistenceCoordinator<TornMarker = unknown> {
  ...
  private installWritePath(): void {
    ...
    // sessions (mirrors fw-invariants).
