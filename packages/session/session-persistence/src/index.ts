 ...
 * @module @forgeweaver/fw-session-persistence
 */

import { Context, Service } from '@forgeweaver/cordis'
import { SessionPreparation } from '@forgeweaver/fw-session'
import type { SessionEvent, SessionId, SessionHeader } from '@forgeweaver/fw-session'
import type { SessionPersistenceRevision } from './revision.ts'

// Re-export the metadata vocabulary so Consumers import it from the Service Definition.
export type { SessionHeader } from '@forgeweaver/fw-session'
