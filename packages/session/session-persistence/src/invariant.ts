/**
 * Package-owned invariant companion for `@forgeweaver/fw-session-persistence`.
 * @module @forgeweaver/fw-session-persistence/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-session-persistence'
