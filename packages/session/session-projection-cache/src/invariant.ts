/**
 * Package-owned invariant companion for `@forgeweaver/fw-session-projection-cache`.
 * @module @forgeweaver/fw-session-projection-cache/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-session-projection-cache'
