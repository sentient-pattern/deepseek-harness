/**
 * Package-owned invariant companion for `@forgeweaver/fw-session-projection`.
 * @module @forgeweaver/fw-session-projection/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-session-projection'
