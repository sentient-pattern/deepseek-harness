/**
 * OpenTelemetry Service Provider for the ForgeWeaver telemetry capability.
 *
 ...
 *
 * @module @forgeweaver/fw-session-telemetry-otel
 */

import { createRequire } from 'node:module'
import z from '@forgeweaver/schemastery'
import type { Context } from '@forgeweaver/cordis'
import type {} from '@forgeweaver/fw-command-feedback'
import {
...
} from '@forgeweaver/fw-session-telemetry'
import { APP_IDENTITY } from '@forgeweaver/fw-llm'
...
// version (same pattern as fw-llm's attribution identity).
...
export class OpenTelemetrySessionBackend extends SessionTelemetryBackend {
  ...
  constructor(ctx: Context, config: Config) {
    ...
    const ledger = this.provider.getLogger('@forgeweaver/fw-session-telemetry-otel', version)
    const ops = this.provider.getLogger('@forgeweaver/fw-session-telemetry-otel/ops', version)
