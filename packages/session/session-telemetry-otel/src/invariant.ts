/**
 * Package-owned invariant companion for `@forgeweaver/fw-session-telemetry-otel`.
 * @module @forgeweaver/fw-session-telemetry-otel/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-session-telemetry-otel'
