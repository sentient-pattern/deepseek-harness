/**
 * Package-owned invariant companion for `@forgeweaver/fw-session-telemetry`.
 * @module @forgeweaver/fw-session-telemetry/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-session-telemetry'
