/**
 * Package-owned invariant companion for `@forgeweaver/fw-session-title-all-prompts-llm`.
 * @module @forgeweaver/fw-session-title-all-prompts-llm/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-session-title-all-prompts-llm'
