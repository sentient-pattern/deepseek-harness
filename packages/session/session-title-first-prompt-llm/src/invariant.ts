/**
 * Package-owned invariant companion for `@forgeweaver/fw-session-title-first-prompt-llm`.
 * @module @forgeweaver/fw-session-title-first-prompt-llm/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-session-title-first-prompt-llm'
