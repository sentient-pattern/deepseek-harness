/**
 * Package-owned invariant companion for `@forgeweaver/fw-session-title-llm`.
 * @module @forgeweaver/fw-session-title-llm/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-session-title-llm'
