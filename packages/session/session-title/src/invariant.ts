/**
 * Package-owned invariant companion for `@forgeweaver/fw-session-title`.
 * @module @forgeweaver/fw-session-title/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-session-title'
