/**
 * Package-owned invariant companion for `@forgeweaver/fw-settings-file`.
 * @module @forgeweaver/fw-settings-file/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-settings-file'
 ...
 * tests; the in-process commit relation is owned by `@forgeweaver/fw-settings`.
 */
