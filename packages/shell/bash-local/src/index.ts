 ...
 * @module @forgeweaver/fw-bash-local
 */
...
export class LocalBashExecutor extends ShellExecutor {
  ...
  resolve(request: ShellExecRequest): ShellExecSpec {
    ...
    return {
      ...
      // Carry stdin/ordinary env/trusted fwEnv through verbatim — optional,
  ...
  private spawnSpec(
    ...
    return {
      ...
      signal,
      // One explicit env map for the seam, layered so the trusted fwEnv
