 ...
 * mirror of `@forgeweaver/fw-bash-sandbox/src/helpers.ts` (the pwsh twin of
 * the bash consumer shares the identical classification dialect).
 *
 * @module @forgeweaver/fw-pwsh-sandbox/helpers
 */

/* jscpd:ignore-start */
import { accessSync, constants, statSync } from 'node:fs'
import type { ShellRunResult } from '@forgeweaver/fw-shell'
import type { RunnerFailureRule } from '@forgeweaver/fw-sandbox'
