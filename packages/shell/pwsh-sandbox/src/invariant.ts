/**
 * Package-owned invariant companion for `@forgeweaver/fw-pwsh-sandbox`.
 * @module @forgeweaver/fw-pwsh-sandbox/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-pwsh-sandbox'
