/**
 * Shared rendering helpers for the shell tools (`fw-tool-bash`,
 * `fw-tool-pwsh`): the exit-status marker contract the tools' renderers
 * emit and the presentation layer parses back.
 * @module @forgeweaver/fw-shell/render
 */
