 ...
 * to `@forgeweaver/fw-jobs`; this seam exposes only process handles. The
 ...
 * root.
 * @module fw-shell/types
 */

import type { SandboxEnforcement, SandboxExecutionPolicy, SandboxMode } from '@forgeweaver/fw-sandbox'
import type { CollectedOutput, DshEnvironment } from '@forgeweaver/fw-subprocess'

export { FW_ENV_PREFIX } from '@forgeweaver/fw-subprocess'
export type { CollectedOutput, DshEnvironment, DshEnvironmentKey } from '@forgeweaver/fw-subprocess'
