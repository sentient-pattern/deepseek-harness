/**
 * Package-owned invariant companion for `@forgeweaver/fw-tool-bash-persistent`.
 * @module @forgeweaver/fw-tool-bash-persistent/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-tool-bash-persistent'
