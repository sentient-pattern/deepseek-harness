 ...
 *
 * @module @forgeweaver/fw-tool-bash/render
 */

import type { ShellProcessRead, ShellRunResult, ShellSandboxInfo, CollectedOutput } from '@forgeweaver/fw-shell'
 ...
 * rendering story, owned by `@forgeweaver/fw-shell` so `fw-tool-pwsh` reuses
 ...
 */
export { parseExitStatus, type ParsedExitStatus } from '@forgeweaver/fw-shell'
