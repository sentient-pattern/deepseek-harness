 ...
 * @module @forgeweaver/fw-tool-pwsh-persistent
 */
...
import type { TerminalReadResult, TerminalSendResult, TerminalSessionId } from '@forgeweaver/fw-terminal'
...
const SHELL_PROMPT = '__FW_PERSISTENT_PWSH_PROMPT__ '
...
function markers(): CommandMarkers {
  ...
  return {
    start: `__FW_PERSISTENT_PWSH_START_${nonce}__`,
    end: `__FW_PERSISTENT_PWSH_END_${nonce}:`,
  }
}
