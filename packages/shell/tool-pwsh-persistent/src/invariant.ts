/**
 * Package-owned invariant companion for `@forgeweaver/fw-tool-pwsh-persistent`.
 * @module @forgeweaver/fw-tool-pwsh-persistent/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-tool-pwsh-persistent'
