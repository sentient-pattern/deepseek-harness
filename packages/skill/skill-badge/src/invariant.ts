/**
 * Package-owned invariant companion for `@forgeweaver/fw-skill-badge`.
 * @module @forgeweaver/fw-skill-badge/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-skill-badge'
