 ...
 * Concrete
 * providers such as `@forgeweaver/fw-skill-filesystem` decide where skills come
 ...
 *
 * @module @forgeweaver/fw-skill
 */

import { Context, Service } from '@forgeweaver/cordis'
import { assertNever } from '@forgeweaver/fw-llm'
import { NamedEntries, ScopedLayers, scopeChainOf, scopeOf } from '@forgeweaver/fw-scope'
...
export type SkillSource = 'project-fw' | 'project-agents' | 'runtime' | 'user-fw' | 'user-agents' | 'custom' | 'bundled' | (string & {})
