...
| Package | Role |
|---|---|
| `@forgeweaver/fw-spill` (this) | Service Definition: abstract service + vocabulary types |
| `@forgeweaver/fw-spill-local` | Service Provider: private session-scoped files on the host filesystem |
| `@forgeweaver/fw-spill-policy` | Consumer: the tool-result policy that spills oversized final results |
