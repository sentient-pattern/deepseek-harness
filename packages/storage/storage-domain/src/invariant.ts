/**
 * Package-owned invariant companion for `@forgeweaver/fw-storage-domain`: every
 ...
 * @module @forgeweaver/fw-storage-domain/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-storage-domain'
