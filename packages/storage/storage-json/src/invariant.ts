/**
 * Package-owned invariant companion for `@forgeweaver/fw-storage-json`.
 * @module @forgeweaver/fw-storage-json/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-storage-json'
