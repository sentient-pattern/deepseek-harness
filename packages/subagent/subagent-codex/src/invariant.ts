/**
 * Package-owned invariant companion for `@forgeweaver/fw-subagent-codex`.
 * @module @forgeweaver/fw-subagent-codex/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-subagent-codex'
