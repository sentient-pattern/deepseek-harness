 ...
 * (`@forgeweaver/fw-subagent-spawn-in-process`, `-fork`, `-acp`) and the model-facing
 * consumer (`@forgeweaver/fw-tool-subagent`) are separate packages.
 *
...
import { assertObjectJsonSchema } from '@forgeweaver/fw-tools'
import type { ContentBlock, MessageId } from '@forgeweaver/fw-llm'
