 ...
 *
 * @module @forgeweaver/fw-subagent/types
 */

import type { Agent, AgentOptions } from '@forgeweaver/fw-agent'
...
import type { ObjectJsonSchema, ToolRestriction } from '@forgeweaver/fw-tools'
