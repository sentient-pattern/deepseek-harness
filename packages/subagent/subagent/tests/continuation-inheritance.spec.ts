...
import SandboxPolicyService, { effectiveSandboxMode, setSandboxMode } from '@forgeweaver/fw-sandbox-policy'
...
import ApprovalService, { effectiveApprovalPolicy } from '@forgeweaver/fw-user-approval'
...
async function setup(script: Script) {
  ...
  const root = mkdtempSync(join(tmpdir(), 'fw-continuation-inherit-'))
  roots.push(root)
