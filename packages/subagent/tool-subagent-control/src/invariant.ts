/**
 * Package-owned invariant companion for `@forgeweaver/fw-tool-subagent-control`.
 * @module @forgeweaver/fw-tool-subagent-control/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-tool-subagent-control'
