/**
 * Package-owned invariant companion for `@forgeweaver/fw-tool-subagent`.
 * @module @forgeweaver/fw-tool-subagent/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-tool-subagent'
