...
import type { ProcessInspectorInternals } from '@forgeweaver/fw-subprocess-local/src/process-inspector.ts'
import { WindowsProcessInspector } from '@forgeweaver/fw-subprocess-local/src/windows-inspector.ts'
