 ...
 * @module fw-subprocess/types
 */

import type { Readable, Writable } from 'node:stream'

/** Namespace prefix reserved for ForgeWeaver-managed child environment facts. */
export const FW_ENV_PREFIX = 'FW_' as const

/** One environment key inside the managed {@link FW_ENV_PREFIX} namespace. */
export type DshEnvironmentKey = `${typeof FW_ENV_PREFIX}${string}`
 ...
 * to `TerminalSignal` in `@forgeweaver/fw-terminal` without a cross-seam dependency;
