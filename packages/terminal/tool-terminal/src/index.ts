 ...
 * @module @forgeweaver/fw-tool-terminal
 */
...
import { TerminalSessionId } from '@forgeweaver/fw-terminal'
import type { TerminalSendResult, TerminalSessionId as TerminalSessionIdType, TerminalSignal } from '@forgeweaver/fw-terminal'
import type {} from '@forgeweaver/fw-jobs'
import { defineTool } from '@forgeweaver/fw-tools'
import type { ToolDefinition } from '@forgeweaver/fw-tools'
  ...
  ctx.tools.register(defineTool({
    ...
    async execute(args: SendArgs, exec) {
      ...
      if (args.run_in_background === true) {
        ...
        if (jobs === undefined) throw new Error('background terminal sends require @forgeweaver/fw-jobs and @forgeweaver/fw-tool-jobs')
