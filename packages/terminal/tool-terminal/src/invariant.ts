/**
 * Package-owned invariant companion for `@forgeweaver/fw-tool-terminal`.
 * @module @forgeweaver/fw-tool-terminal/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-tool-terminal'
