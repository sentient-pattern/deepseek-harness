...
- **Built mode requires current artifacts** — run `pnpm run build` before selecting `FW_EXAMPLE_MODE=lib`; source mode remains the zero-build path.
