/**
 * Package-owned invariant companion for `@forgeweaver/fw-acp-snapshot`.
 * @module @forgeweaver/fw-acp-snapshot/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-acp-snapshot'
