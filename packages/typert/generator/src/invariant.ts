/**
 * Package-owned invariant companion for `@forgeweaver/fw-typert-generator`.
 * @module @forgeweaver/fw-typert-generator/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-typert-generator'
