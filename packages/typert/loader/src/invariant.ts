/**
 * Package-owned invariant companion for `@forgeweaver/fw-typert-loader`.
 * @module @forgeweaver/fw-typert-loader/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-typert-loader'
