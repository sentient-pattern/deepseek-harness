...
The `@forgeweaver/fw-typert-registry/types` subpath contains the pure contribution and record contracts. [`fw-typert-loader`](../loader/README.md) discovers and registers generated host artifacts in Loader compositions; direct `ctx.typert.register()` supports other composition owners.
