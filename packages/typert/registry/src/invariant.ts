/**
 * Package-owned invariant companion for `@forgeweaver/fw-typert-registry`.
 * @module @forgeweaver/fw-typert-registry/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-typert-registry'
