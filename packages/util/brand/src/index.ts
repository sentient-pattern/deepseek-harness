 ...
 *
 * Policy: a package brands the ids it owns — `CallId` in fw-llm (tool-call
 * correlation), the shared agent/session `SessionId` in fw-session, and
 * `JobId` in fw-jobs. Branding is for ids that cross package boundaries and
