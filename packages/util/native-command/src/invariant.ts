/**
 * Package-owned invariant companion for `@forgeweaver/fw-native-command`.
 * @module @forgeweaver/fw-native-command/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-native-command'
