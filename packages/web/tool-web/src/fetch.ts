...
import type { GenericCallView, JsonValue, ToolResult, WebFetchResultView } from '@forgeweaver/fw-tools'
import type { WebFetchBody, WebFetchResult } from '@forgeweaver/fw-web'
 ...
 * `@forgeweaver/fw-tool-call-timeout-policy`, not a model argument.
 *
 ...
 *   `ToolDefinition.timeoutMs` for `@forgeweaver/fw-tool-call-timeout-policy` to enforce.
