/**
 * `@forgeweaver/fw-web-fetch-http`: registers an anonymous public HTTP(S)
 ...
 *
 * @module @forgeweaver/fw-web-fetch-http
 */
...
export const DEFAULT_USER_AGENT = 'forgeweaver-harness/0.0.1 (+https://github.com/forgeweaver)'
