 ...
 * `@forgeweaver/fw-tool-web`. Requests carry no browser cookies or ambient credentials.
 *
 ...
 * @module @forgeweaver/fw-web-fetch-http/provider
 */

import { WebError } from '@forgeweaver/fw-web'
import type { WebFetchBody, WebFetchProvider, WebFetchRequest, WebFetchResult } from '@forgeweaver/fw-web'
