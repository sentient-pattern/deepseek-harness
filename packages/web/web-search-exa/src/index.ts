/**
 * `@forgeweaver/fw-web-search-exa`: registers an Exa-backed `WebSearchProvider`
 ...
 * seam's provider registry, exactly as `@forgeweaver/fw-llm-forgeweaver`
 * registers an adapter into `ctx.llm`. The key is owned by `@forgeweaver/fw-web`.
 *
 * @module @forgeweaver/fw-web-search-exa
 */
