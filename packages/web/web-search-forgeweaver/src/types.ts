/**
 * Provider-private wire types for ForgeWeaver's Anthropic-compatible Messages API. Citeable
 ...
 * @module @forgeweaver/fw-web-search-forgeweaver/types
 */
...
/** ForgeWeaver's Anthropic Messages response envelope. */
export interface AnthropicResponse {
  content?: ContentBlock[]
}

/** ForgeWeaver's error response envelope (best-effort; fields vary). */
