/**
 * Package-owned invariant companion for `@forgeweaver/fw-workflow-worker-thread`.
 * @module @forgeweaver/fw-workflow-worker-thread/invariant
 */
...
const PACKAGE_NAME = '@forgeweaver/fw-workflow-worker-thread'
