 ...
 * @module @forgeweaver/fw-workflow-worker-thread/runtime
 */

import * as vm from 'node:vm'
import type { ContentBlock } from '@forgeweaver/fw-llm'
import { SessionId } from '@forgeweaver/fw-session'
import { assertObjectJsonSchema, JsonSchemaError } from '@forgeweaver/fw-tools'
import type { ObjectJsonSchema } from '@forgeweaver/fw-tools'
import { isFatalWorkflowError, WorkflowError } from '@forgeweaver/fw-workflow'
import type {
