/**
 * Package-owned invariant companion for `@forgeweaver/fw-workspace`.
 * @module @forgeweaver/fw-workspace/invariant
 */
...
import { WorkspaceId } from '@forgeweaver/fw-workspace'

const PACKAGE_NAME = '@forgeweaver/fw-workspace'
