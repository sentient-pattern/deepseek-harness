...
const DEPLOY_ROOT_PACKAGE = 'fw-jsonrpc-agent-pkg'
/** The closed-runtime app entry inside the deployed closure. */
const ENTRY_BIN = 'node_modules/@forgeweaver/fw-sdk-jsonrpc-demo/lib/packaged-bin.js'
const OUTPUT_BASENAME = 'fw-jsonrpc-agent-pkg'
...
const PYTHON_RUNTIME_DIR = 'python/sdk-runtime/src/forgeweaver_harness_runtime/runtime'
