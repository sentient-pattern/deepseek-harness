...
import {
  ...
  REGION_BEGIN,
  REGION_END,
} from '@forgeweaver/fw-typert-generator'
import type { CordisCatalogPolicy } from '@forgeweaver/fw-typert-generator'
 ...
 * The scan that enforces this list reads EVERY `declare module '@forgeweaver/cordis'`
...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  fwHomePath: 'not a service: boot-provided root accessor function (typeof fwHomePath | undefined) for Loader !!js config expressions — packages/boot/app-boot/README.md owns the boot contract',
 ...
 * scan reads EVERY `declare module '@forgeweaver/cordis'` Events merge under
