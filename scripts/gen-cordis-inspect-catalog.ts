...
import type { CordisCatalogModel, ServiceMethodEntry } from '@forgeweaver/fw-typert-generator'
...
function main(): void {
  ...
  const source = projector.renderRuntimeApi(clientModel(model))
    .replaceAll('@forgeweaver/fw-tool-cordis/api-catalog', '@forgeweaver/fw-cordis-client-runner/client/api-catalog')
