...
const REPOSITORY_URL = 'https://github.com/sentient-pattern/deepseek-harness'
...
function githubTarget(
  ...
  if (image) return `https://raw.githubusercontent.com/forgeweaver/forgeweaver-harness/${repositoryRef}/${path}${suffix}`
