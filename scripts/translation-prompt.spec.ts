...
const retainedExamples = [
  ...
  ['### Slang/jargon → Professional phrasing', 'The committed agent workflow lives in .agents/skills/fw-translate-docs', '仓库内置的 agent 工作流见 .agents/skills/fw-translate-docs'],
  ['### "For humans" — translate the intent, not the word', 'For humans, start with the development guide', '面向开发者：请先阅读开发指南'],
  ['### Code block comments — NEVER translate', '# full-screen TUI coding agent (needs FORGEWEAVER_API_KEY)', 'keep exactly as-is, byte-for-byte'],
