...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/shell/shell': { kind: 'indirect', reason: 'The service interface delegates all model rendering to fw-tool-bash.' },
  'packages/shell/shell-env': { kind: 'indirect', reason: 'The env service exposes managed FW_* facts through the shell tools (fw-tool-bash/fw-tool-pwsh); it registers no prompt or schema of its own.' },
  'packages/shell/bash-local': { kind: 'indirect', reason: 'The executor backend delegates model rendering to fw-tool-bash.' },
  'packages/shell/pwsh-local': { kind: 'indirect', reason: 'The executor backend delegates model rendering to fw-tool-pwsh.' },
  'packages/code-runtime/code-runtime': { kind: 'indirect', reason: 'The service interface delegates model rendering to Code Mode in fw-tools.' },
  'packages/core/agent-tool-presentation': { kind: 'indirect', reason: 'The row only selects between the two projections fw-tools owns; it registers no prompt, schema, or result of its own.' },
  'packages/code-runtime/code-runtime-worker-thread': { kind: 'indirect', reason: 'The worker backend delegates model rendering to Code Mode in fw-tools.' },
  'packages/code-runtime/code-runtime-python': { kind: 'indirect', reason: 'The CPython subprocess backend delegates model rendering to Code Mode in fw-tools.' },
  ...
  'packages/client/ui-jobs': { kind: 'none', reason: 'Browser-side read-only projection of ctx.jobs records; fw-tool-jobs owns the model-facing behavior.' },
  ...
  'packages/client/ui-plan': { kind: 'indirect', reason: 'The chip dispatches /plan off; fw-plan-mode owns the model-visible policy, exit tool, and logged state.' },
  'packages/client/ui-user-questions': { kind: 'indirect', reason: 'The package mounts fw-tool-ask-user; that tool owns the model-visible schema and answer rendering.' },
  ...
  'packages/fs/fs': { kind: 'indirect', reason: 'The service interface delegates model rendering to fw-tool-fs.' },
  'packages/e2b/fs-e2b': { kind: 'indirect', reason: 'The provider backend delegates model rendering to fw-tool-fs.' },
  'packages/fs/fs-local': { kind: 'indirect', reason: 'The provider backend delegates model rendering to fw-tool-fs.' },
  ...
  'packages/lsp/lsp': { kind: 'indirect', reason: 'The provider registry delegates model rendering to fw-tool-lsp.' },
  'packages/lsp/lsp-stdio': { kind: 'indirect', reason: 'The provider backend delegates model rendering to fw-tool-lsp.' },
  ...
  'packages/sandbox/sandbox-local': { kind: 'indirect', reason: 'The provider backend delegates model rendering to fw-bash-sandbox and fw-tool-bash.' },
  ...
  'packages/identity/anonymous-user-id': { kind: 'none', reason: 'The shared identifier reaches ForgeWeaver only as model-hidden HTTP metadata; it registers nothing model-facing.' },
  'packages/skill/skill': { kind: 'indirect', reason: 'The provider registry delegates model rendering to fw-tool-skill.' },
  'packages/skill/skill-badge': { kind: 'indirect', reason: 'The bundled provider delegates model rendering to fw-tool-skill.' },
  'packages/skill/skill-filesystem': { kind: 'indirect', reason: 'The provider backend delegates model rendering to fw-tool-skill.' },
  ...
  'packages/jobs/jobs-local': { kind: 'indirect', reason: 'The registry backend delegates model rendering to producer plugins and fw-tool-jobs.' },
  'packages/examples/acp-demo': { kind: 'indirect', reason: 'The app bundle delegates request composition to fw-agent-spine-demo and fw-acp.' },
  ...
  'packages/interaction/permission-presets': { kind: 'indirect', reason: 'The service writes mechanism events rendered by fw-user-approval and fw-tool-bash.' },
  ...
  'packages/web/web': { kind: 'indirect', reason: 'The provider registry delegates model rendering to fw-tool-web.' },
  'packages/web/web-fetch-http': { kind: 'indirect', reason: 'The provider backend delegates model rendering to fw-tool-web.' },
  'packages/web/web-search-exa': { kind: 'indirect', reason: 'The provider backend delegates model rendering to fw-tool-web.' },
