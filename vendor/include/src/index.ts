import { EntryGroup, EntryTree, isJsExpr, type EntryOptions } from '@forgeweaver/cordis-plugin-loader'
 ...
 * (`fw --dump-config`) parses and prints exactly the dialect this include
 * mounts.
 */
 ...
 * (`fw --dump-config`) so a dump can never drift from what boots. The input
